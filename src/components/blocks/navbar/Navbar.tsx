    ...
    <Fragment>
      ...
      <div id="offcanvas-nav" data-bs-scroll="true" className="navbar-collapse offcanvas offcanvas-nav offcanvas-start">
        <div className="offcanvas-header d-lg-none">
          <h3 className="text-white fs-30 mb-0">Menú</h3>
        ...
        <div className="offcanvas-body ms-lg-auto d-flex flex-column h-100">
          <ul className="navbar-nav">
              ...
              <ul className="dropdown-menu mega-menu mega-menu-dark mega-menu-img">
                <li className="mega-menu-content mega-menu-scroll">
                  ...
                  <span className="d-none d-lg-flex">
                    ...
                    <strong>Desplácese para ver más</strong>
                  </span>
                </li>
              </ul>
            </li> */}
            ...
            {/* ===================== Notícias ===================== */}
            <li className="nav-item dropdown">
              <NextLink href='/noticias' title="Noticias" className="nav-link" />
            </li>
            {/* ===================== Mision y Vision ===================== */}
            {/* <li className="nav-item dropdown">
              <NextLink href='/mision-y-vision' title="Misión y visión" className="nav-link" />
            </li> */}
            {/*  ===================== Mas nav item  ===================== */}
            <li className="nav-item dropdown">
            <NextLink href='/biblioteca-virtual' title="Estudios" className="nav-link" />
              {/* <DropdownToggleLink title="Más" className="nav-link dropdown-toggle" /> */}
              ...
              {/* <ul className="dropdown-menu"> */}
                ...
                {/* <ListItemLink href="/educacion-metropolitana" title="Educación Metropolitana" linkClassName="dropdown-item" /> */}

                {/* <ListItemLink href="/biblioteca-virtual" title="Biblioteca Virtual" linkClassName="dropdown-item" /> */}
              {/* </ul> */}
            </li>

            {/* ===================== Contáctenos ===================== */}
                  <li className="nav-item dropdown">
              <NextLink href='/contactenos' title="Contáctenos" className="nav-link" />
            </li>
